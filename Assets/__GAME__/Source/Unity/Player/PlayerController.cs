...
namespace __GAME__.Source.Unity.Player
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public PlayerController(InteractionDetector interaction)
        {
        ...
        private void Awake()
        {
            ...
            _interaction = GetComponent<InteractionDetector>();
            _cam          = Camera.main;
        ...
        private void ProcessInputCommands()
        {
            ...
            if (_inputHandler.InventoryPressed)
                ShowInventory();
        }
        ...
        {
            var inventory = Main.Instance?.Get<Features.InventoryFeature>();
            if (inventory != null)
                inventory.PrintToConsole();
        }
